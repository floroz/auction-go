...
export const file_auth_v1_auth_service: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_timestamp]);
...
/**
 * @generated from message auth.v1.TokenClaims
 */
export type TokenClaims = Message<"auth.v1.TokenClaims"> & {
  /**
  ...
  /**
   * @generated from field: string iss = 6;
   */
  iss: string;
  ...
  /**
   * @generated from field: double iat = 8;
   */
  iat: number;
};

/**
 * Describes the message auth.v1.TokenClaims.
